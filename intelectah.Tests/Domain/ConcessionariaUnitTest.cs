...
namespace intelectah.Tests.Domain
{
    ...
    public class ConcessionariaUnitTest
    {
        ...
        {
            var concessionaria = new Concessionaria("Concessionaria Name", "Concessionaria Address", "Concessionaria City", "Concessionaria State", "12345678", "11987654321", "client@example.com", 10);
            ...
            Assert.Equal("client@example.com", concessionaria.Email);
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("", "Concessionaria Address", "Concessionaria City", "Concessionaria State", "12345678", "11987654321", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "", "Concessionaria City", "Concessionaria State", "12345678", "11987654321", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "Concessionaria Address", "", "Concessionaria State", "12345678", "11987654321", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "Concessionaria Address", "Concessionaria City", "", "12345678", "11987654321", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "Concessionaria Address", "Concessionaria City", "Concessionaria State", "", "11987654321", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "Concessionaria Address", "Concessionaria City", "Concessionaria State", "12345678", "", "client@example.com", 10));
        ...
        {
            var exception = Assert.Throws<DomainExceptionValidation>(() => new Concessionaria("Concessionaria Name", "Concessionaria Address", "Concessionaria City", "Concessionaria State", "12345678", "11987654321", "client@example.com", 0));
